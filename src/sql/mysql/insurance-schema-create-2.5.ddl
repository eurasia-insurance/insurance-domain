...
CREATE TABLE POLICY (ID INTEGER AUTO_INCREMENT NOT NULL, DATE_OF_ISSUE DATE, DATE_OF_TERMINATION DATE, POLICY_NUMBER VARCHAR(255), UPDATED DATETIME NOT NULL, ACTUAL_AMOUNT DOUBLE, ACTUAL_CURRENCY VARCHAR(255), CALCULATED_AMOUNT DOUBLE, CALCULATED_CURRENCY VARCHAR(255), INSURANT_EMAIL VARCHAR(255), INSURANT_ID_NUMBER VARCHAR(255), REQUESTER_PHONE_NUMBER VARCHAR(255), INSURANT_COMPANY_NAME VARCHAR(255), INSURANT_PERSON_DOB DATE, INSURANT_PERSON_GENDER VARCHAR(255), INSURANT_PERSON_NAME VARCHAR(255), INSURANT_PERSON_PATRONYMIC VARCHAR(255), INSURANT_PERSON_SURENAME VARCHAR(255), PERIOD_FROM DATE, PERIOD_TO DATE, PRIMARY KEY (ID))
