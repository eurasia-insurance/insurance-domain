CREATE TABLE IMAGE (ID INTEGER AUTO_INCREMENT NOT NULL, CONTENT LONGBLOB, FILE_NAME VARCHAR(255), MIME_TYPE VARCHAR(255), UPDATED DATETIME, PRIMARY KEY (ID))
CREATE TABLE IDENTITY_CARD (ID INTEGER AUTO_INCREMENT NOT NULL, DATE_OF_ISSUE DATE, ISSUING_AUTHORITY VARCHAR(255), NUMBER VARCHAR(255), TYPE VARCHAR(255), UPDATED DATETIME, BACKSIDE_IMAGE_ID INTEGER, FRONTSIDE_IMAGE_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE VEHICLE_CERTIFICATE (ID INTEGER AUTO_INCREMENT NOT NULL, DATE_OF_ISSUE DATE, VEHICLE_CERTITFICATE_NUMBER VARCHAR(255), VEHICLE_REGISTRATION_NUMBER VARCHAR(255), UPDATED DATETIME, BACKSIDE_IMAGE_ID INTEGER, FRONTSIDE_IMAGE_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE USER (ID INTEGER AUTO_INCREMENT NOT NULL, EMAIL VARCHAR(255), HIDDEN TINYINT(1) default 0, NAME VARCHAR(255), UPDATED DATETIME, PRIMARY KEY (ID))
CREATE TABLE USER_LOGIN (ID INTEGER AUTO_INCREMENT NOT NULL, NAME VARCHAR(255) UNIQUE, UPDATED DATETIME, USER_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE POS_CONTACT_EMAIL (ID INTEGER AUTO_INCREMENT NOT NULL, EMAIL_ADDRESS VARCHAR(255), UPDATED DATETIME, POS_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE POS_CONTACT_PHONE (ID INTEGER AUTO_INCREMENT NOT NULL, PHONE_NUMBER VARCHAR(255), PHONE_TYPE VARCHAR(255), UPDATED DATETIME, POS_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE USER_GROUP (ID INTEGER AUTO_INCREMENT NOT NULL, NAME VARCHAR(255), UPDATED DATETIME, PRIMARY KEY (ID))
CREATE TABLE REQUEST (ID INTEGER AUTO_INCREMENT NOT NULL, DTYPE VARCHAR(31), ACCEPTED DATETIME, CLOSED DATETIME, COMPLETED DATETIME, CREATED DATETIME, NOTE LONGTEXT, PROGRESS_STATUS VARCHAR(255), STATUS VARCHAR(255), UPDATED DATETIME, REQUESTER_INET_ADDR VARCHAR(255), REQUESTER_INET_HOST VARCHAR(255), REQUESTER_ALLOW_PROCESS_PERSONAL_DATA TINYINT(1) default 0, REQUESTER_ALLOW_SPAM TINYINT(1) default 0, REQUESTER_EMAIL VARCHAR(255), REQUESTER_ID_NUMBER VARCHAR(255), REQUESTER_NAME VARCHAR(255), REQUESTER_PHONE_NUMBER VARCHAR(255), REQUESTER_PREFER_LANGUAGE VARCHAR(255), UTM_CAMPAIGN VARCHAR(255), UTM_CONTENT VARCHAR(255), UTM_MEDIUM VARCHAR(255), UTM_SOURCE VARCHAR(255), UTM_TERM VARCHAR(255), ACCEPTED_BY_USER_ID INTEGER, CLOSED_BY_USER_ID INTEGER, COMPLETED_BY_USER_ID INTEGER, CREATED_BY_USER_ID INTEGER, PRIMARY KEY (ID))
...
CREATE TABLE DRIVER_LICENSE (ID INTEGER AUTO_INCREMENT NOT NULL, DATE_OF_ISSUE DATE, NUMBER VARCHAR(255), UPDATED DATETIME, BACKSIDE_IMAGE_ID INTEGER, FRONTSIDE_IMAGE_ID INTEGER, PRIMARY KEY (ID))
...
CREATE TABLE VEHICLE (ID INTEGER AUTO_INCREMENT NOT NULL, DTYPE VARCHAR(31), REGISTRATION_AREA VARCHAR(255), REGISTRATION_CITY VARCHAR(255), COLOR VARCHAR(255), MANUFACTURER_NAME VARCHAR(255), MODEL_NAME VARCHAR(255), UPDATED DATETIME, VIN_CODE VARCHAR(255), VEHICLE_YOM INTEGER, VEHICLE_CERTIFICATE_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE DRIVER (ID INTEGER AUTO_INCREMENT NOT NULL, DTYPE VARCHAR(31), ID_NUMBER VARCHAR(255), UPDATED DATETIME, DRIVER_LICENSE_ID INTEGER, IDENTITY_CARD_ID INTEGER, PRIMARY KEY (ID))
