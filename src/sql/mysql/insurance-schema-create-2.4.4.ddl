CREATE TABLE IMAGE (ID INTEGER AUTO_INCREMENT NOT NULL, CONTENT LONGBLOB, FILE_NAME VARCHAR(255), MIME_TYPE VARCHAR(255), OPTLOCK DATETIME, PRIMARY KEY (ID))
CREATE TABLE IDENTITY_CARD (ID INTEGER AUTO_INCREMENT NOT NULL, DATE_OF_ISSUE DATE, ISSUING_AUTHORITY VARCHAR(255), NUMBER VARCHAR(255), TYPE VARCHAR(255), OPTLOCK DATETIME, BACKSIDE_IMAGE_ID INTEGER, FRONTSIDE_IMAGE_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE VEHICLE_CERTIFICATE (ID INTEGER AUTO_INCREMENT NOT NULL, DATE_OF_ISSUE DATE, VEHICLE_CERTITFICATE_NUMBER VARCHAR(255), VEHICLE_REGISTRATION_NUMBER VARCHAR(255), OPTLOCK DATETIME, BACKSIDE_IMAGE_ID INTEGER, FRONTSIDE_IMAGE_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE USER (ID INTEGER AUTO_INCREMENT NOT NULL, EMAIL VARCHAR(255), HIDDEN TINYINT(1) default 0, NAME VARCHAR(255), OPTLOCK DATETIME, PRIMARY KEY (ID))
CREATE TABLE USER_LOGIN (ID INTEGER AUTO_INCREMENT NOT NULL, NAME VARCHAR(255) UNIQUE, OPTLOCK DATETIME, USER_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE POS_CONTACT_EMAIL (ID INTEGER AUTO_INCREMENT NOT NULL, EMAIL_ADDRESS VARCHAR(255), OPTLOCK DATETIME, POS_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE POS_CONTACT_PHONE (ID INTEGER AUTO_INCREMENT NOT NULL, PHONE_NUMBER VARCHAR(255), PHONE_TYPE VARCHAR(255), OPTLOCK DATETIME, POS_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE USER_GROUP (ID INTEGER AUTO_INCREMENT NOT NULL, NAME VARCHAR(255), OPTLOCK DATETIME, PRIMARY KEY (ID))
CREATE TABLE REQUEST (ID INTEGER AUTO_INCREMENT NOT NULL, DTYPE VARCHAR(31), ACCEPTED DATETIME, CLOSED DATETIME, COMPLETED DATETIME, CREATED DATETIME, NOTE LONGTEXT, PROGRESS_STATUS VARCHAR(255), STATUS VARCHAR(255), UPDATED DATETIME, OPTLOCK DATETIME, REQUESTER_INET_ADDR VARCHAR(255), REQUESTER_INET_HOST VARCHAR(255), REQUESTER_ALLOW_PROCESS_PERSONAL_DATA TINYINT(1) default 0, REQUESTER_ALLOW_SPAM TINYINT(1) default 0, REQUESTER_EMAIL VARCHAR(255), REQUESTER_ID_NUMBER VARCHAR(255), REQUESTER_NAME VARCHAR(255), REQUESTER_PHONE_NUMBER VARCHAR(255), REQUESTER_PREFER_LANGUAGE VARCHAR(255), UTM_CAMPAIGN VARCHAR(255), UTM_CONTENT VARCHAR(255), UTM_MEDIUM VARCHAR(255), UTM_SOURCE VARCHAR(255), UTM_TERM VARCHAR(255), ACCEPTED_BY_USER_ID INTEGER, CLOSED_BY_USER_ID INTEGER, COMPLETED_BY_USER_ID INTEGER, CREATED_BY_USER_ID INTEGER, PRIMARY KEY (ID))
...
CREATE TABLE DRIVER_LICENSE (ID INTEGER AUTO_INCREMENT NOT NULL, DATE_OF_ISSUE DATE, NUMBER VARCHAR(255), OPTLOCK DATETIME, BACKSIDE_IMAGE_ID INTEGER, FRONTSIDE_IMAGE_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE INSURANCE_REQUEST (ID INTEGER NOT NULL, AGREEMENT_NUMBER VARCHAR(255), TRANSACTION_PROBLEM VARCHAR(255), TRANSACTION_STATUS VARCHAR(255), RTYPE VARCHAR(255), PAYMENT_AMOUNT DOUBLE, PAYMENT_CARD VARCHAR(255), PAYMENT_CURRENCY VARCHAR(255), PAYMENT_INSTANT DATETIME, PAYMENT_INVOICE_NUMBER VARCHAR(255), PAYMENT_METHOD_NAME VARCHAR(255), PAYER_NAME VARCHAR(255), PAYMENT_REFERENCE VARCHAR(255), PAYMENT_STATUS VARCHAR(255), PRIMARY KEY (ID))
CREATE TABLE POS (ID INTEGER AUTO_INCREMENT NOT NULL, IS_AVAILABLE TINYINT(1) default 0, IS_OWN_OFFICE TINYINT(1) default 0, IS_DELIVERY_SERVICE_AVAILABLE TINYINT(1) default 0, NAME VARCHAR(255), IS_PICKUP_AVAILABLE TINYINT(1) default 0, OPTLOCK DATETIME, ADDRESS_CITY VARCHAR(255), ADDRESS_POSTINDEX VARCHAR(255), ADDRESS_STREET VARCHAR(255), GEO_LATITUDE DOUBLE, GEO_LONGITUDE DOUBLE, PRIMARY KEY (ID))
...
CREATE TABLE VEHICLE (ID INTEGER AUTO_INCREMENT NOT NULL, DTYPE VARCHAR(31), REGISTRATION_AREA VARCHAR(255), REGISTRATION_CITY VARCHAR(255), COLOR VARCHAR(255), MANUFACTURER_NAME VARCHAR(255), MODEL_NAME VARCHAR(255), OPTLOCK DATETIME, VIN_CODE VARCHAR(255), VEHICLE_YOM INTEGER, VEHICLE_CERTIFICATE_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE DRIVER (ID INTEGER AUTO_INCREMENT NOT NULL, DTYPE VARCHAR(31), ID_NUMBER VARCHAR(255), OPTLOCK DATETIME, DRIVER_LICENSE_ID INTEGER, IDENTITY_CARD_ID INTEGER, PRIMARY KEY (ID))
