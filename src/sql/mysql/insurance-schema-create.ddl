...
CREATE TABLE INSURANCE_REQUEST (ID INTEGER NOT NULL, AGREEMENT_NUMBER VARCHAR(255), INSURANCE_REQUEST_CANCELLATION_REASON VARCHAR(255), INSURANCE_REQUEST_STATUS VARCHAR(255), INVOICE_AMOUNT DOUBLE, INVOICE_CURRENCY VARCHAR(255), INVOICE_LANGUAGE INTEGER, INVOICE_NUMBER VARCHAR(255), INVOICE_PAYEE_EMAIL VARCHAR(255), INVOICE_PAYEE_NAME VARCHAR(255), INVOICE_PAYEE_PHONE VARCHAR(255), INVOICE_PAYEE_TAXPAYER_NUMBER VARCHAR(255), INVOICE_PRODUCT_NAME VARCHAR(255), INVOICE_QUANTITY INTEGER, PAYER_NAME VARCHAR(255), PAYMENT_AMOUNT DOUBLE, PAYMENT_CANCELED_INSTANT DATETIME, PAYMENT_CARD VARCHAR(255), PAYMENT_CARD_BANK VARCHAR(255), PAYMENT_CURRENCY VARCHAR(255), PAYMENT_INSTANT DATETIME, PAYMENT_METHOD_NAME VARCHAR(255), PAYMENT_REFERENCE VARCHAR(255), RTYPE VARCHAR(255), PRIMARY KEY (ID))
